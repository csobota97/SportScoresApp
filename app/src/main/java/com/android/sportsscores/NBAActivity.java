    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNcaaFootballButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(NBAActivity.this, NCAAFootballActivity.class);
        ...
        mNcaaBasketballButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(NBAActivity.this, NCAABasketballActivity.class);
                startActivity(intent);
            }
        });
        ...
        mNcaaBaseballButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(NBAActivity.this, NCAABaseballActivity.class);
                startActivity(intent);
            }
        });
        ...
        mMlbButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //MLB Button
                Intent intent = new Intent(NBAActivity.this, MLBActivity.class);
                startActivity(intent);
            }
        });
        ...
        mNflButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //NFL Button
                Intent intent = new Intent(NBAActivity.this, NFLActivity.class);
                startActivity(intent);
            }
        });
    }
